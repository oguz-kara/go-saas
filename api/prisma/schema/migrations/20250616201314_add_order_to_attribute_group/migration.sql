...
-- CreateIndex
CREATE UNIQUE INDEX "AttributeValue_value_attributeTypeId_parentId_key" ON "AttributeValue"("value", "attributeTypeId", "parentId");

-- CreateIndex
CREATE UNIQUE INDEX "AttributeValue_value_attributeTypeId_key" ON "AttributeValue"("value", "attributeTypeId");

-- CreateIndex
CREATE UNIQUE INDEX "AttributeValue_code_attributeTypeId_key" ON "AttributeValue"("code", "attributeTypeId");
